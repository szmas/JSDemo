    ...
    try {
        ...
        if (typeof (HL.Cookie.Get("all_jie_mian")) == "undefined") {
            if (window.screen.width >= 1280) {
                document.write('<link href="//f.51240.com/img/css/1040.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" />')
            }
            if (sj_jie_mian == "1") {
                document.write('<link href="//f.51240.com/img/css/sj.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" media="screen and (max-width:800px)" />');
            ...
            if (HL.Cookie.Get("all_jie_mian") == "sj" && sj_jie_mian == "1") {
                document.write('<link href="//f.51240.com/img/css/sj.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" />');
                if (typeof (css_file_sj) != "undefined") {
...
lazyLoad = (function () {
    ...
    function b(o) {
        l = document.body;
        f = document.compatMode == "BackCompat" ? l : document.documentElement;
        user_agent = navigator.userAgent.toLowerCase();
        e = o || ["img", "iframe"]
    }
    function c() {
        for (var s = 0, o = e.length; s < o; s++) {
            var t = document.getElementsByTagName(e[s]);
            for (var r = 0, p = t.length; r < p; r++) {
                if (typeof (t[r]) == "object" && t[r].getAttribute("l-l-c")) {
                    a.push(t[r])
                }
            }
        }
    ...
    function k() {
        ...
        for (var w in n) {
            if (s > w) {
                ...
                var u = q.length;
                for (var p = 0; p < u; p++) {
                    var v = a[q[p]].getAttribute("l-l-c");
                    if (v.indexOf("/img/ico/") > 0) {
                        a[q[p]].style.backgroundImage = "url(" + v + ")";
                        a[q[p]].src = "//f.51240.com/t.gif"
                    } else {
                        a[q[p]].src = v
                    }
                }
